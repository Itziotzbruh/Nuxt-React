<template>
  <div class="event-card-event-card" v-bind:class="rootClassName">
...
.event-card-title {
  ...
  font-style: normal;
  font-weight: 600;
  margin-bottom: var(--dl-space-space-halfunit13);
}
.event-card-text {
  color: var(--dl-color-scheme-darkblue);
  font-size: 14px;
...
.event-card-root-class-name {
  background-color: #161616;
}
.event-card-root-class-name1 {
  background-color: #161616;
}
.event-card-root-class-name2 {
  background-color: #141414;
}
.event-card-root-class-name3 {
